...
@teresa = User.create({active: true, email: "al@prc.com", first_name: "alan", last_name: "bar", password: "secrets1", password_confirmation: "secrets1", role: "administrator"});
...
@cmu = Client.create({ name: "pnc", street_1: "123", street_2: "234", city: "Pittsburgh", state: "PA", zip: "11111", contact_phone: "1231231234", contact_email: "pnc@pnc.com", contact_title: "manager", contact_first_name: "marge", contact_last_name: "robert", active: true });
...
# Audit.create([{start_date: Date.current, name: "Phipps Conservatory Garden", end_date: Date.current, user: @teresa, client: @cmu}]);
